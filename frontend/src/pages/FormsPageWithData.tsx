...
import { Card, Typography, Button, Space, List, Tag, Input, Select, Spin, Empty, Tabs } from 'antd';
import { FormOutlined, PlusOutlined, SearchOutlined, EyeOutlined, EditOutlined, FileTextOutlined, SolutionOutlined } from '@ant-design/icons';
...
const FormsPageWithData: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<string>('student-assessment');
  ...
  const tabItems = [
    {
      ...
      children: studentAssessmentContent,
    },
    {
